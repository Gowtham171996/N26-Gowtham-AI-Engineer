...
def RerankerModel() -> CrossEncoder:
    try:
        ...
        RERANKER_MODEL = CrossEncoder(
            ...
            max_length=config[
                "CHUNK_SIZE"
            ],  # Set a reasonable max length for the concatenated query+chunk
        )
        print(
            "INFO: Cross-Encoder Reranker 'ms-marco-MiniLM-L-6-v2' loaded successfully."
        )
        ...
        RERANKER_MODEL = (
            None  # Set to None to allow the system to fall back to no reranking
        )
